...
- (void)reloadTable {
    self.games = [OSAITableTennis games];
...
- (void)createGameButtonTap {
    OSAIGameModel *game = [OSAITableTennis createGameWithLeftPlayerName:@"Foo" rightPlayerName:@"Bar" gameType:OSAIGameTypeGame userLogin:@"demo"];
